...
if len(args) != 4:
    help_message = ("Usage:  python doLungExtraction.py" +
...
# input_file_name = "/Users/ntustison/Pkg/ANTsRNetApps/PigLungSegmentation/Data/Example/Pig6_I_S_8_PEEP10_phase-01Low.nii.gz"
# output_file_name = "testpy.nii.gz"
# reorient_template_file_name = "/Users/ntustison/Pkg/ANTsRNetApps/PigLungSegmentation/Data/Template/T_template0_resampled.nii.gz"
...
start_time = time.time()
weights_file_name = "/Users/ntustison/Pkg/ANTsRNetApps/PigLungSegmentation/Data/Weights/pigLungExtractionWeights.h5"

if not os.path.exists(weights_file_name):
    raise AttributeError("Weights file does not exist.")
...
# probability_images_array <- decode_unet(predictedData, reorient_template)
